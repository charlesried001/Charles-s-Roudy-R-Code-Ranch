...
With an R squared of 0.129, the results of our regression is not
...
``` r
suppressMessages(attach(dat_use))
model4 <- lm(INCWAGE ~ AGE + I(AGE^2) + I(AGE^3) + I(AGE^4) + educ_hs + educ_college+ educ_advdeg + white + AfAm + Hispanic)
...
```
    ...
    ## Residuals:
    ##     Min      1Q  Median      3Q     Max 
    ## -103524  -25482   -8176   11532  610170 
    ## 
    ## Coefficients:
    ##                Estimate Std. Error t value Pr(>|t|)    
    ## (Intercept)  -8.481e+04  9.868e+04  -0.859 0.390112    
    ## AGE           5.063e+03  9.579e+03   0.529 0.597134    
    ## I(AGE^2)     -4.867e-01  3.385e+02  -0.001 0.998853    
    ## I(AGE^3)     -1.723e+00  5.171e+00  -0.333 0.738990    
    ## I(AGE^4)      1.595e-02  2.887e-02   0.552 0.580705    
    ## educ_hs      -6.744e+03  1.036e+03  -6.510 7.66e-11 ***
    ## educ_college  2.987e+04  1.012e+03  29.522  < 2e-16 ***
    ## educ_advdeg   4.801e+04  1.049e+03  45.772  < 2e-16 ***
    ## white         1.728e+03  1.029e+03   1.680 0.093065 .  
    ## AfAm         -4.900e+03  1.351e+03  -3.627 0.000288 ***
    ## Hispanic     -6.274e+03  1.138e+03  -5.513 3.57e-08 ***
    ## ---
    ## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
    ## 
    ## Residual standard error: 59720 on 27181 degrees of freedom
    ## Multiple R-squared:   0.13,  Adjusted R-squared:  0.1296 
    ## F-statistic:   406 on 10 and 27181 DF,  p-value: < 2.2e-16
...
```
    ...
    ##                             (1,035.924)        
    ##                                                
    ## educ_college               29,865.720***       
    ##                             (1,011.644)        
    ##                                                
    ## educ_advdeg                48,006.600***       
    ##                             (1,048.819)        
    ##                                                
    ## white                       1,727.579*         
    ##                             (1,028.623)        
    ...
    ## R2                             0.130           
    ## Adjusted R2                    0.130           
    ## Residual Std. Error   59,720.050 (df = 27181)  
    ## F Statistic         405.991*** (df = 10; 27181)
    ## ===============================================
    ## Note:               *p<0.1; **p<0.05; ***p<0.01
...
```
    ...
    ##                                (1)                         (2)                        (3)                         (4)                        (5)            
    ## ------------------------------------------------------------------------------------------------------------------------------------------------------------
    ## AGE                        3,797.762***              -106,297.700**                                            5,063.055                    0.362           
    ##                             (278.609)                 (49,475.030)                                            (9,579.455)                  (0.312)          
    ##                                                                                                                                                             
    ## I(AGE2)                     -35.145***                 5,349.783**                                              -0.487                      -0.012          
    ##                              (3.122)                   (2,356.464)                                             (338.510)                   (0.011)          
    ##                                                                                                                                                             
    ## I(AGE3)                                                -126.972**                                               -1.723                      0.0002          
    ##                                                         (54.837)                                                (5.171)                    (0.0002)         
    ##                                                                                                                                                             
    ## I(AGE4)                                                  1.447**                                                 0.016                     -0.00000         
    ##                                                          (0.624)                                                (0.029)                   (0.00000)         
    ##                                                                                                                                                             
    ## I(AGE5)                                                 -0.006**                                                                                            
    ##                                                          (0.003)                                                                                            
    ...
    ##                                                                                                                                                             
    ##                                                                                                                                                             
    ## educ_hs                   -6,770.665***               -6,731.209***              -6,835.500***               -6,743.637***                -0.120***         
    ##                            (1,036.138)                 (1,035.857)                (1,037.447)                 (1,035.924)                  (0.034)          
    ##                                                                                                                                                             
    ## educ_college              29,877.880***               29,868.500***              29,655.810***               29,865.720***                 0.487***         
    ##                            (1,011.847)                 (1,011.565)                (1,012.797)                 (1,011.644)                  (0.033)          
    ##                                                                                                                                                             
    ## educ_advdeg               48,276.170***               48,043.200***              48,595.430***               48,006.600***                 0.765***         
    ##                            (1,046.577)                 (1,048.858)                (1,047.025)                 (1,048.819)                  (0.034)          
    ##                                                                                                                                                             
    ## white                       1,653.394                  1,737.401*                  1,321.813                  1,727.579*                   0.103***         
    ##                            (1,028.571)                 (1,028.551)                (1,029.158)                 (1,028.623)                  (0.033)          
    ##                                                                                                                                                             
    ## AfAm                      -4,895.436***               -4,865.105***              -4,919.818***               -4,900.456***                 0.115***         
    ##                            (1,351.567)                 (1,351.236)                (1,353.317)                 (1,351.254)                  (0.044)          
    ##                                                                                                                                                             
    ## Hispanic                  -6,226.070***               -6,264.325***              -5,986.012***               -6,273.532***                -0.189***         
    ##                            (1,138.101)                 (1,137.932)                (1,139.230)                 (1,138.014)                  (0.037)          
    ##                                                                                                                                                             
    ## Constant                  -49,518.720***              817,797.400**              -69,311.550***               -84,809.660                   5.887*          
    ##                            (6,040.617)                (405,605.700)               (5,305.787)                (98,681.470)                  (3.214)          
    ##                                                                                                                                                             
    ## ------------------------------------------------------------------------------------------------------------------------------------------------------------
    ## Observations                  27,192                     27,192                      27,192                     27,192                      27,192          
    ## R2                            0.129                       0.130                      0.127                       0.130                      0.035           
    ## Adjusted R2                   0.129                       0.130                      0.127                       0.130                      0.034           
    ## Residual Std. Error  59,733.910 (df = 27183)     59,715.370 (df = 27180)    59,811.340 (df = 27184)     59,720.050 (df = 27181)       1.945 (df = 27181)    
    ## F Statistic         505.427*** (df = 8; 27183) 369.619*** (df = 11; 27180) 565.946*** (df = 7; 27184) 405.991*** (df = 10; 27181) 97.839*** (df = 10; 27181)
    ## ============================================================================================================================================================
    ## Note:                                                                                                                            *p<0.1; **p<0.05; ***p<0.01
